...
class LogAktivitasSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $logs = [
            ...
            ['user_id' => 2, 'aktivitas' => 'Memproses pengembalian alat telat untuk pemijaman ID #3 dan mengenakan denda.'],
            ['user_id' => 1, 'aktivitas' => 'Mengubah konfigurasi akses aplikasi.'],
        ];
